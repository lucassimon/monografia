...
% Texto
\comentario{Monografia apresentada ao Curso de Sistemas de Informação da Pontifícia Universidade Católica de Minas Gerais,
...
\setboolean{@openright}{false}
\include{texto/ambiente-node}

\include{texto/metodologia}

\include{texto/requisitos-e-prototipos}

\include{texto/experimentos-e-resultados}

\include{texto/conclusao-e-trabalhos-futuros}
