...
\label{single-thread}
  ...
  Através de outra biblioteca, \textit{multi-node} \citeonline{Zyp:2010}, é possível compartilhar sockets nos servidores.
...
%  conseguindo vantagens e evitando armadilhas dessa abordagem.\cite{Hughes:2012}
  ...
  semanticamente conhecida pelo on(). Essa seção é melhor descrita e exemplificada por \citeonline{Wilson:2013} 
...
\label{framework-express}
  ...
  \citeonline{Powers:2012} compara que o \textit{Express.Js} é parecido com o \textit{framework} Sinatra \footnote{Framework escrito em Ruby para criar aplicações Web. 
