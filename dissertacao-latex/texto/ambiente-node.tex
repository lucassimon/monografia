...
\label{chamadas-de-retorno-e-callback-hell}
  ...
  O Node.Js utiliza o JavaScript Enginie V8, desenvolvido pela empresa Google, como linguagem de programção
...
%  neste emaranhado de chamadas de retorno.
  ...
  Neste artigo \citeonline{Strongloop:2013} investigou-se três possibilidades de mitigar o problema dos \textit{callbacks hell}, com o 
...
\label{single-thread}
  ...
  Através de outra biblioteca, \textit{multi-node} \citeonline{Zyp:2010}, é possivel compartilhar sockets nos servidores.
  ...
  Com a \texit{thread} única é possível suportar um alto número de conexões, em conjunto com a repetição implícita existente no Node.Js. 
...
%  conseguindo vantagens e evitando armadilhas dessa abordagem.\cite{Hughes:2012}
  ...
  Aprofundando \citeonline{Pereira:2013} cita o módulo EventEmitter o responsável por emitir estes eventos e em 
  ...
  Essa seção é melhor descrita e exemplificada por \citeonline{Wilson:2013} em seu livro que nos mostra o uso e o 
...
\label{framework-express}
  ...
  \citeonline{Powers:2012} descreve que no geral um \textit{framework} ajuda na infraestrutura e que nos permite criar sites e aplicações
  ...
  ou diretório e seu papel. Entretanto \citeonline{Pereira:2013, Wilson:2013} aprofundam mais neste assunto que podem ser vistos
  ...
  esperadas por seu código. \citeonline{Wilson:2013} complementa que este arquivo ajuda a prevenir que alterações 
  futuras em módulos de terceiros quebrem a lógica da aplicação.

  No livro, \citeonline{Wilson:2013} exibe um exemplo do arquivo 
