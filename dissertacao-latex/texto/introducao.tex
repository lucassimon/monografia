...
% Texto do capítulo
  ...
  Este problema de desempenho dos aplicativos Web é influênciada pelo consumo de memória RAM. \citeonline{Abernethy:2011}, explica que 
...
\label{motivacao}
  ...
  Com o grande crescimento dos usuário da internet existe a necessidade de que aplicações para web sejam capazes de suportar milhares de usuários,
